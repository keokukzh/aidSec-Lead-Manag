...
new_leads = [
    {'Firma': 'VertragsZentrum', 'Website': 'vertragszentrum.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Lischer Zemp & Partner', 'Website': 'swanlex.ch', 'EMail': '', 'Stadt': 'Luzern', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Opferhilfe beider Basel', 'Website': 'opferhilfe-beiderbasel.ch', 'EMail': '', 'Stadt': 'Basel', 'Telefon': '+41 61 205 09 10', 'WordPress': 'Ja'},
    {'Firma': 'Lei Nobs Harder Advokatur', 'Website': 'frauenfeld-anwalt.ch', 'EMail': '', 'Stadt': 'Frauenfeld', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'konkurs-anwaelte.ch', 'Website': 'konkurs-anwaelte.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
]
