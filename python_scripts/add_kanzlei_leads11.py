...
new_leads = [
    # Medizinrecht
    {'Firma': 'Wernli Anwaltskanzlei', 'Website': 'wernlilaw.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},

    # Glarus/Linth
    {'Firma': 'Müller Streiff & Partner', 'Website': 'law-msp.ch', 'EMail': '', 'Stadt': 'Glarus', 'Telefon': '', 'WordPress': 'Ja'},

    # Baurecht
    {'Firma': 'Baurechtspartner', 'Website': 'baurechtspartner.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Seidel + Partner', 'Website': 'seidelpartner.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},

    # Energierecht
    {'Firma': 'Baur Hürlimann AG', 'Website': 'bhlaw.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},

    # Zürich Agglomeration
    {'Firma': 'INPF Rechtsanwälte', 'Website': 'inpf.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
]
