...
new_leads = [
    {'Firma': 'Versicherte Schweiz', 'Website': 'versicherte-schweiz.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Häusermann + Partner Erbrecht', 'Website': 'erbrecht.ch', 'EMail': '', 'Stadt': 'Bern', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'lawBrander', 'Website': 'lawbrander.com', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Blum&Grob Rechtsanwälte', 'Website': 'blumgrob.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Eigenmann Associés', 'Website': 'eigenmann-avocats.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
]
