...
# Known contact data from web research - including newly found ones
known_contacts = {
    ...
    # NEW - from latest web research
    "dreiding.ch": {"Email": "", "Telefon": ""},  # Praxis aufgelöst
    ...
    "socin22.ch": {"Email": "", "Telefon": ""},  # Keine Daten gefunden
    ...
    "praxis-schuster.ch": {"Email": "", "Telefon": ""},  # Keine Daten gefunden
