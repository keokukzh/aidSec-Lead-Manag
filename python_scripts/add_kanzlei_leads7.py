...
new_leads = [
    # KMU/Wirtschaftsrecht
    {'Firma': 'Thommen Law & Risk Management', 'Website': 'thommen-law.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},

    # Strafrecht
    {'Firma': 'OG42 Rechtsanwälte', 'Website': 'og42.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Anwaltskanzlei Strafrecht', 'Website': 'anwaltskanzlei-strafrecht.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Rechtsanwalt Marc Schmid', 'Website': 'rechtsschmid.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},

    # Sozialversicherungsrecht
    {'Firma': 'HMV Rechtsanwälte', 'Website': 'hmvlaw.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},

    # Winterthur
    {'Firma': 'Anwalt Winterthur', 'Website': 'anwaltwinterthur.com', 'EMail': '', 'Stadt': 'Winterthur', 'Telefon': '', 'WordPress': 'Ja'},
]
