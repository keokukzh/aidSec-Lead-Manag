...
new_leads = [
    {'Firma': 'Bogensberger Law', 'Website': 'bogensbergerlaw.ch', 'EMail': '', 'Stadt': '', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Reichlin Hess AG', 'Website': 'reichlinhess.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},
    {'Firma': 'Good Rechtsanwälte GmbH', 'Website': 'good-zuerich.ch', 'EMail': '', 'Stadt': 'Zürich', 'Telefon': '', 'WordPress': 'Ja'},
]
